$NativeTigerSentenceModelHash = '4E6D79B957A55EDF35CD9E2E66C62BD0BBE598581B7DC088B462122A713172A7'
...
function Assert-NativeTigerSentenceModel([string]$Path) {
    ...
    if ((Get-Item -LiteralPath $Path).Length -ne 460693519 -or
        (Get-FileHash -LiteralPath $Path -Algorithm SHA256).Hash -ne $NativeTigerSentenceModelHash) {
        throw 'Sentence model does not match the validated TCSKNM03 fivegram model.'
    }
}
...
function Copy-NativeTigerSentenceModel([string]$Source, [string]$Destination) {
    ...
    [ordered]@{ model='sentence-fivegram-mobile.bin'; format='TCSKNM03'; bytes=460693519; sha256=$NativeTigerSentenceModelHash.ToLowerInvariant();
        ...
        source='brightmart char5 context128 converted to TCSKNM03 q16; shared with tiger-sentense-rime';
        source_sha256='4e6d79b957a55edf35cd9e2e66c62bd0bbe598581b7dc088b462122a713172a7';
