...
int wmain(int argc,wchar_t** argv) {
    try {
        ...
        for(UINT dpi:{96u,120u,144u,192u}) {
            ...
            require(pos.x+w<=work.right-2 && pos.y+h==caret.top-5,"Above placement/right avoidance failed");
            const auto smaller=placement.place(caret,work,w,10);
            require(smaller.y+10==caret.top-5,"Shrink lost remembered above placement");
