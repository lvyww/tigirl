...
def main():
    ...
    (stage / 'Models').mkdir()
    os.link(ROOT / 'data/Models/sentence-fivegram-mobile.bin', stage / 'Models/sentence-fivegram-mobile.bin')
    keys = []
    ...
    report = dict(status='measured', installed=False, physical_input=False, stage=str(stage),
                  ...
                  model_sha256=sha(ROOT / 'data/Models/sentence-fivegram-mobile.bin'),
